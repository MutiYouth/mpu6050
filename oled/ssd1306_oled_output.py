...
def draw_text(text, width, height, fontsize):
    ...
    font = ImageFont.truetype("/home/pi/proj/pi_device/oled/doc/ARIALN.TTF", fontsize)  # "arial.ttf", fontsize
...
if __name__ == '__main__':
    while True:
        ...
        draw_text("Oled 24.4.6\nAuthor w.\n v0.1.0", device.width, device.height, 12)
        time.sleep(2)
